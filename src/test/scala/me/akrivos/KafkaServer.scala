...
// Taken from cake solutions:
// https://github.com/cakesolutions/scala-kafka-client/blob/master/testkit/src/main/scala/cakesolutions.kafka/testkit/KafkaServer.scala
